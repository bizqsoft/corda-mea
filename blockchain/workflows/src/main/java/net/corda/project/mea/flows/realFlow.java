...
public class realFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final Command<realContact.Commands.Create> txCommand = new Command<>(
                    new realContact.Commands.Create(),
                    Arrays.asList(realState.getSender().getOwningKey(), realState.getReceiver().getOwningKey()));
            final TransactionBuilder txBuilder = new TransactionBuilder(notary)
                    .addOutputState(realState, realContact.ID)
    ...
    @InitiatedBy(realFlow.Initiator.class)
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("This must be an IOU transaction.", output instanceof realState);
                        realState iou = (realState) output;
