...
public class matchContract implements Contract {
    public static final String ID = "net.corda.project.mea.contracts.matchContract";
    ...
    public void verify(LedgerTransaction tx) {
        ...
        requireThat(require -> {
            ...
            final matchState out = tx.outputsOfType(matchState.class).get(0);
